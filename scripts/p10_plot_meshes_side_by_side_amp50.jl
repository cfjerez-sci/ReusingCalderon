# Same as p10_plot_meshes_side_by_side_amp30.jl but for the amplitude=50%
# case -- the most extreme perturbation tested, for which the DOF-aligned
# frozen Calderon preconditioner still converged in 15 iterations (vs 13
# for a freshly-rebuilt preconditioner).
#
# Only exercises the `geo` target (mesh generation, no EFIE assembly),
# and amplitude=0.50/realization=1 was already computed by the sweep,
...
outfile = projectdir("data", "figures", "p10_mesh_side_by_side_amp50.html")
